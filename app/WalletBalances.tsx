  ...
  if (!isConnected) {
    return (
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
        <p className="text-gray-500 text-sm">Connect your wallet to see real token balances.</p>
      </div>
    );
  }
    ...
    return (
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-400 text-sm">Fetching wallet balances...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
      ...
      <div className="space-y-3">
        ...
        {tokens.length === 0 && ethBalance && (
          <p className="text-gray-500 text-sm">No ERC-20 tokens found on Ethereum mainnet.</p>
        )}
      </div>
    </div>
  );
