...
// v21 → v22 (ITEM 0g): lockstep with lp-pnl-events-v30 — Uniswap/HyperSwap
// events are now historically priced rather than estimated.
...
function buildActivityUrl(pos: AerodromePosition): string | null {
  ...
  if (HYPEREVM_PROTOCOLS.has(pos.protocol)) {
    ...
    if (pos.status === "Closed") params.set("closed", "1");
