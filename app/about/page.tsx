...
const FEATURES: string[] = [
  ...
  "Real-time on-chain data — Aerodrome, Uniswap V3, Velodrome, Orca, Raydium, Cetus, Bluefin, Momentum, HyperSwap, KittenSwap, PRJX, PancakeSwap",
        ...
        <div style={{ ...cardStyle, animationDelay: "0.05s" }}>
          ...
          <p style={{ color: C.textMid, fontSize: 15.5, lineHeight: 1.75 }}>
            ...
            <strong style={{ color: C.textBright, fontWeight: 600 }}>
              Uniswap, Aerodrome, Velodrome, Orca, Raydium, Cetus, Bluefin, Momentum
            </strong>
            , and{" "}
