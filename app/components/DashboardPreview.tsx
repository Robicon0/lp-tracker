...
const ALLOC = [
  { pct: 35, color: "#00ff41", label: "Uniswap" },
  { pct: 26, color: "#00e5ff", label: "Orca" },
  { pct: 20, color: "#9945ff", label: "Aave" },
  { pct: 12, color: "#4da2ff", label: "Morpho" },
  { pct: 7, color: "#ff3366", label: "Cetus" },
];
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignSelf: "stretch" }}>
      ...
      <div className="flex items-center justify-between border-b border-[#1f1f1f] pb-3 mb-3">
        <span className="text-[12px] text-[#888] tracking-[0.15em] uppercase">
          {"// portfolio_overview.live"}
        </span>
        <span className="flex items-center gap-1.5 text-[12px] text-[#00ff41] tracking-[0.1em]">
      ...
      <div
        className="border border-[#1f1f1f] bg-[#0a0a0a] flex flex-col"
        style={{ flex: 1 }}
      >
        {/* Top metrics */}
        ...
        >
            ...
            {POSITIONS.map((p, i) => (
              ...
              >
                <div>
                  ...
                  <div className="text-[11px] text-[#888] tracking-[0.08em]">{p.proto}</div>
                </div>
          ...
          <div className="p-4 flex flex-col">
            <div className="text-[11px] text-[#888] tracking-[0.15em] uppercase mb-3">Allocation</div>
            <Donut />
          </div>
        </div>
        ...
        {/* Footer chains */}
        <div className="flex items-center gap-6 px-4 py-2.5 text-[11px] text-[#888]">
          <div className="flex items-center gap-1.5">
            <div className="w-[5px] h-[5px] bg-[#00e5ff]" />
            <span>EVM</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-[5px] h-[5px] bg-[#9945ff]" />
            <span>SOLANA</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-[5px] h-[5px] bg-[#4da2ff]" />
            <span>SUI</span>
          </div>
