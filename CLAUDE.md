...
- Suilend (Sui lending): Package `0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf`. Users own `ObligationOwnerCap<MAIN_POOL>` objects (NOT Obligation). Cap has `obligation_id` → fetch Obligation via `sui_getObject`. Obligation.deposits[].market_value is a Decimal (/ 10^18) = USD value directly. MAIN_POOL type = `<pkg>::suilend::MAIN_POOL`. Lending Market ID = `0x84030d26...`. Compute token amount = USD / CoinGecko price for correct balance display.
